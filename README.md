...
You can also specify a preferred terminal emulator:

``` elisp
(setq server-menu-terminal "alacritty")
```
C_ la terminal specified is not one of the pre-configured ones (gnome-terminal, konsole, xterm), it will be launched with the `-e` flag.
